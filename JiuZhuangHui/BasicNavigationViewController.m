...
- (void)viewDidLoad {
    [super viewDidLoad];
    self.navigationBar.backIndicatorImage = [UIImage imageNamed:@"backitem_arrow"];
    self.navigationBar.backIndicatorTransitionMaskImage = [UIImage imageNamed:@"backitem_arrow"];
